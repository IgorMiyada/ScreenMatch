...
Screenmatch is a Java application that allows you to search for movies and series using the [OMDb](https://www.omdbapi.com/) API. In addition, you can create users and playlists. All data is stored locally in JSON files.
